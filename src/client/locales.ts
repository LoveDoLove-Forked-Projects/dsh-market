...
export const zh = {
  ...
  // The way out of a refusal that is not a gamble (#581): the newest release
  // that still declares this host. Copy says what it IS (declared compatible)
  // and never "downgrade", which reads as damage.
